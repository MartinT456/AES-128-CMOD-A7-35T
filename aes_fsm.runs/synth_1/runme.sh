...
HD_PWD='F:/FPGA_Repos/aes_fsm/aes_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_encryption.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes_encryption.tcl
